...
const T = {
  en: {
    ...
    no_payout_triggered: "No payout triggered",
    partial_payout: "Partial Payout",
    full_payout: "Full Payout",
    no_payout: "No Payout",
    rainfall_analysis: "Rainfall Detail & Payout Analysis",
    intensity: "Intensity",
    duration: "Duration",
    trigger: "Trigger",
    how_payout_calculated: "How payout is calculated",
    data_source: "Data Source",
    calculation: "Calculation",
    payout_rules: "Payout Rules",
    tap_day_instruction: "Tap a day to view rainfall and payout details",
    view_details_instruction: "Click to view details",
    rainfall_explanation: "This shows rainfall intensity and how payout is calculated for the selected day",
    hourly_rainfall: "Hourly Rainfall",
    normal: "Normal",
    peak: "Peak",
    avg: "avg",
    peak_highlight: "Peak: {val} mm — highlighted in amber",
    ...
    no_rainfall_recorded: "No Rainfall Recorded",
    no_rainfall_desc: "No rainfall events were logged for this day at your station.",
    loading_rainfall: "Loading rainfall data...",
    trigger_formula: "Trigger Formula",
  ...
  hi: {
    ...
    no_payout_triggered: "कोई भुगतान ट्रिगर नहीं हुआ",
    partial_payout: "आंशिक भुगतान",
    full_payout: "पूर्ण भुगतान",
    no_payout: "कोई भुगतान नहीं",
    rainfall_analysis: "वर्षा विवरण और भुगतान विश्लेषण",
    intensity: "तीव्रता",
    duration: "अवधि",
    trigger: "ट्रिगर",
    how_payout_calculated: "भुगतान की गणना कैसे की जाती है",
    data_source: "डेटा स्रोत",
    calculation: "गणना",
    payout_rules: "भुगतान नियम",
    tap_day_instruction: "वर्षा और भुगतान विवरण देखने के लिए किसी दिन पर टैप करें",
    view_details_instruction: "विवरण देखने के लिए क्लिक करें",
    rainfall_explanation: "यह वर्षा की तीव्रता और चयनित दिन के लिए भुगतान की गणना कैसे की जाती है, यह दर्शाता है",
    hourly_rainfall: "प्रति घंटा वर्षा",
    normal: "सामान्य",
    peak: "पीक",
    avg: "औसत",
    peak_highlight: "पीक: {val} मिमी — एम्बर में हाइलाइट किया गया",
    total_rainfall: "कुल वर्षा",
    events_recorded: "रिकॉर्ड की गई घटनाएं",
    readings: "रीडिंग",
    zone_risk_score: "क्षेत्र जोखिम स्कोर",
    low: "कम",
    moderate: "मध्यम",
    high: "उच्च",
    payout_details: "भुगतान विवरण",
    no_rainfall_recorded: "कोई वर्षा रिकॉर्ड नहीं की गई",
    no_rainfall_desc: "आपके स्टेशन पर इस दिन के लिए कोई वर्षा घटना दर्ज नहीं की गई थी।",
    loading_rainfall: "वर्षा डेटा लोड हो रहा है...",
    trigger_formula: "ट्रिगर फॉर्मूला",
    threshold_label: "सीमा",
  },
  ta: {
    ...
    no_payout_triggered: "பணம் தூண்டப்படவில்லை",
    partial_payout: "பகுதி பணம்",
    full_payout: "முழு பணம்",
    no_payout: "பணம் இல்லை",
    rainfall_analysis: "மழை விவரம் மற்றும் பணம் பகுப்பாய்வு",
    intensity: "தீவிரம்",
    duration: "காலம்",
    trigger: "தூண்டுதல்",
    how_payout_calculated: "பணம் எவ்வாறு கணக்கிடப்படுகிறது",
    data_source: "தரவு ஆதாரம்",
    calculation: "கணக்கீடு",
    payout_rules: "பணம் விதிகள்",
    tap_day_instruction: "மழை மற்றும் பணம் விவரங்களைக் காண ஒரு நாளைத் தட்டவும்",
    view_details_instruction: "விவரங்களைக் காண கிளிக் செய்யவும்",
    rainfall_explanation: "இது மழையின் தீவிரம் மற்றும் தேர்ந்தெடுக்கப்பட்ட நாளுக்கான பணம் எவ்வாறு கணக்கிடப்படுகிறது என்பதைக் காட்டுகிறது",
    hourly_rainfall: "மணிநேர மழை",
    normal: "சாதாரண",
    peak: "உச்சம்",
    avg: "சராசரி",
    peak_highlight: "உச்சம்: {val} மிமீ — அம்பர் நிறத்தில் சிறப்பிக்கப்பட்டுள்ளது",
    total_rainfall: "மொத்த மழை",
    events_recorded: "பதிவு செய்யப்பட்ட நிகழ்வுகள்",
    readings: "வாசிப்புகள்",
    zone_risk_score: "மண்டல அபாய மதிப்பெண்",
    low: "குறைந்த",
    moderate: "மிதமான",
    high: "அதிக",
    payout_details: "பணம் விவரங்கள்",
    no_rainfall_recorded: "மழை பதிவு செய்யப்படவில்லை",
    no_rainfall_desc: "உங்கள் நிலையத்தில் இந்த நாளில் மழை நிகழ்வுகள் எதுவும் பதிவு செய்யப்படவில்லை.",
    loading_rainfall: "மழை தரவு ஏற்றப்படுகிறது...",
    trigger_formula: "தூண்டுதல் சூத்திரம்",
    threshold_label: "வரம்பு",
  }
};
